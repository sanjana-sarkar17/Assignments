---
title: "Assignment4_PredictiveAnalysis"
author: "SANJANA_SARKAR_721"
date: "2026-02-15"
...
```{r}
F_model = lm(RI~Na+Mg+Al+Si+K+Ca+Ba+Fe, data=fgl_veh)
summary(F_model)
```
**Interpretation**\
...
```{r}
Quadratic_model = lm(RI ~ Fe + I(Fe^2), data= fgl_veh)
...
```{r}
summary(S_model)$r.squared
summary(F_model)$r.squared
```
**Interpretation**\
